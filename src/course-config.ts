...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP1439",
  title: "How to Write a Call of Cthulhu Scenario",
  session: "Semester 1",
  year: 2027,
  level: 1,
  ...
  endDate: "2027-05-28",
  description:
    "A studio course in scenario design, using Call of Cthulhu as the " +
    "working system. Twelve weeks turn one spark of interest into a " +
    "complete, playtested scenario — the design process a Keeper goes " +
    "through, not Mythos trivia or rules memorisation.",
  tags: ["scenario design", "tabletop RPG", "horror"],
